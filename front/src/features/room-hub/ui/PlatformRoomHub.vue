...
const { lastRoom, loading: lastRoomLoading } = useLastRoom(
  platformConfig.roomType,
);
...
<template>
  <div
    class="platform-room-hub flex min-h-full flex-1 flex-col"
    :class="`platform-room-hub--${platform}`"
  >
    <div
      class="platform-room-hub__center flex flex-1 flex-col items-center justify-start p-6 md:p-10"
    >
      <div class="platform-room-hub__container w-full max-w-md space-y-8">
        <header class="platform-room-hub__header space-y-3">
          ...
          <div class="platform-room-hub__brand flex items-center gap-4">
            ...
            <div class="min-w-0">
              <h1
                class="platform-room-hub__title page-title text-3xl md:text-[2rem]"
              >
        ...
        <div class="platform-room-hub__actions space-y-5">
          ...
          <div class="platform-room-hub__create-block space-y-2">
            <button
              ...
              :class="[
                platformConfig.brandButton,
                platformConfig.brandButtonShadow,
              ]"
            ...
            <p
              class="platform-room-hub__create-hint text-center text-xs text-muted-foreground"
            >
          ...
          <div class="platform-room-hub__divider relative py-1">
            ...
            <div class="relative flex justify-center">
              <span
                class="bg-background px-3 text-xs font-medium text-muted-foreground"
                >or</span
              >
            </div>
          </div>
          ...
          >
            <div class="platform-room-hub__join-header mb-3">
              ...
              <h2 class="mt-0.5 text-sm font-semibold tracking-tight">
                Join by room ID
              </h2>
            </div>
            ...
            <div class="platform-room-hub__join-row flex gap-2">
              <div class="relative min-w-0 flex-1">
                <PhLinkSimple
                  class="input-adornment input-adornment--leading"
                />
                <Input
                  :id="`${platform}-room-id`"
            ...
            <p
              v-if="joinError"
              class="platform-room-hub__error mt-2 text-xs text-destructive"
            >
              {{ joinError }}
            </p>
            <p
